...
<html class="no-js" lang="en">
  <head>
    ...
    <title>About Us ||  MedizinPlus</title>
  ...
  <body>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        <p>MedizinPlus is an Online Pharmacy Service. </p>
        <p>We provide products under 6 major categories such as Health and Medicine, Baby Care, Home and Health, Beauty and Cosmetics, Vitamins and Personal Care. </p>
